...
# load WPS meta table
RNAiInfo = read.csv('input/RNAi_condition_information.csv')
...
# load DEG table
DEGinfo = read.csv('input/DEG_clusters.csv')
DEtbl = read.csv('input/DE_analysis_result_of_metabolic_WPS.csv')
