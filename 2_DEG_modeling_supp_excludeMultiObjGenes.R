# 05312023
# note: the CR-model needs to be updated (to the no-assumption basic version) if we need to publish the randomization result.
...
# try to make plots for the 54% and 23% seperately 
